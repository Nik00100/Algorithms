package ya_int_0322.kosmopolitizm_done.q;
...
/**
 * Создаю два списка стран, отсортированных по минимальному доходу и индексу.
 * Первый список - страны, в которых не требуется высшее образование.
 * Второй список - все страны.
 * Предварительно подготавливаю хеш-таблицы (минимальный доход - наиболее привлекательная страна, соответствующая данному доходу)
 * Далее использую бинарный поиск, для определения страны, зная зарплату человека (индекс ищу в хеш-таблице
 * и если возможен переезд по родству, сравниваю с индексом страны проживания родителей).
 * */
