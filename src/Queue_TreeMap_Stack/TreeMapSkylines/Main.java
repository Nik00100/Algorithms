package Queue_TreeMap_Stack.TreeMapSkylines;
...
*
* The basic idea of this solutions is to find the critical points that change the max height
* among the buildings on the left*/
